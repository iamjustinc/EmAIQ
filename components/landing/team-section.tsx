  ...
  return (
    <section id="teams" className="py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div className="rounded-[28px] border border-border/70 bg-card/80 p-6 shadow-xl shadow-black/5">
          <div className="rounded-3xl border border-border/60 bg-background p-5">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div>
                ...
                <div className="h-2 rounded-full bg-muted overflow-hidden">
                  <div className="h-full w-[31%] rounded-full bg-primary/80" />
                </div>
              </div>
              <div>
                <div className="mb-2 flex items-center justify-between text-sm">
                ...
                <div className="h-2 rounded-full bg-muted overflow-hidden">
                  <div className="h-full w-[19%] rounded-full bg-primary/60" />
                </div>
              </div>
            </div>
